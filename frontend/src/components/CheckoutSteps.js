        ...
        <div position='static' color='inherit'>
            <Toolbar>
                <Box className={classes.title} style={{display: 'flex', justifyContent:'space-around'}}>
                    <Box>
                        {step1 ? (
                            <Button><Link className='linkStyle' to='/login'>Login</Link></Button>
                        ) : (
                    ...
                    <Box>
                        {step2 ? (
                            <Button><Link className='linkStyle' to='/shipping'>Shipping</Link></Button>
                        ) : (
                    ...
                    <Box>
                        {step3 ? (
                            <Button><Link className='linkStyle' to='/payment'>Payment</Link></Button>
                        ) : (
                    ...
                    <Box>
                        {step4 ? (
                            <Button><Link className='linkStyle' to='/placeorder'>Place Order</Link></Button>
                        ) : (
